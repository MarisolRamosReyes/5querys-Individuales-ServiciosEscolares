CREATE DATABASE IF NOT EXISTS SchoolServicesMarisol
...
-- Career
CREATE TABLE Career (
    idCareer INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(50) NOT NULL,
...
CREATE TABLE StudyPlan (
    idStudyPlan INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(50) NOT NULL,
...
CREATE TABLE InstitutionalScholarship (
    idInstitutionalScholarship INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(50) NOT NULL,
...
CREATE TABLE InternalScholarshipDetails (
    idInternalScholarshipDetails INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE ExternalScholarshipDetails (
    idExternalScholarshipDetails INT PRIMARY KEY AUTO_INCREMENT,
    idStudent INT NOT NULL,
...
CREATE TABLE ExternalScholarship (
    idExternalScholarship INT PRIMARY KEY AUTO_INCREMENT,
...
INSERT INTO ExternalScholarshipDetails (idExternalScholarship, idStudent, institution, campus, major, semester, idUserCreate, creationDate)
VALUES (1, 1, 'Instituto Tecnologico Superior de México', 'campus Monclova', 'Ing Industrial',7, 1, '2023-10-23'), 
       (1, 2, 'Instituto Tecnologico Superior de México', 'campus Monclova', 'Ing Mecanica',5, 1, '2023-10-23'), 
	   (1, 3, 'Instituto Tecnologico Superior de México', 'campus Monclova', 'Ing Informatica', 3, 1, '2023-10-23');
